...
<body class="app sidebar-mini pace-done sidenav-toggled">
    ...
    <header class="app-header">
      <ul class="app-nav">
       ...
       <!-- menu Lateral-->
    <div class="bar__overlay" data-toggle="sidebar"></div>
    <aside class="app-sidebar">
       <!-- Botón de alternancia de la barra lateral--><a class="app-sidebar__toggle" href="#" data-toggle="sidebar" ></a>
      <ul class="app-menu">
        <li><a class="app-menu__item" href="inicio.php"><i class="app-menu__icon fa fa-home fa-lg"></i><span class="app-menu__label">Inicio</span></a></li>
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-user fa-lg"></i><span class="app-menu__label">Perfil</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item" href="login.php"> Cerrar Sesión</a></li>
          </ul>
        </li>
      </ul>
    </aside>
    ...
    <div id="carousel1" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
              <img src="/Bocos_Fruit/img/imagen0.jpg" alt="" width="400" height="850">
       </div>
       <div class="carousel-item">
              <img src="/Bocos_Fruit/img/imagen1.jpg" alt="" width="400" height="850">
          </div>
          <div class="carousel-item">
              <img src="/Bocos_Fruit/img/imagen2.jpg" alt="" width="400" height="850">
          </div>
            <div class="carousel-item">
              <img src="/Bocos_Fruit/img/imagen3.jpg" alt="" width="400" height="850">
            </div>
            <div class="carousel-item">
              <img src="/Bocos_Fruit/img/imagen4.jpg" alt="" width="400" height="850">
            </div>
        </div>
